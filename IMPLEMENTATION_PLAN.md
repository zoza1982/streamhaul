...
| P4-4 | `sh-transport`: WebRTC backend (`str0m`) + **GCC** congestion control | sh-transport, sh-adaptive | P4-1 | network-engineer | webrtc loopback (3 ✅) + GCC sim (11 ✅) | ✅ | feat/P4-4-webrtc-gcc |
