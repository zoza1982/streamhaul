...
/// Modifier-key bit positions for [`InputEvent::modifiers`].
pub mod modifiers {
    /// Shift held.
...
fn event_type_to_u8(event_type: EventType) -> u8 {
    match event_type {
...
fn event_type_from_u8(byte: u8) -> Result<EventType, ProtocolError> {
    match byte {
